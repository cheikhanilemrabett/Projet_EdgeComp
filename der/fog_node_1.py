...
def main():
    try:
        print("🚀 Démarrage de Fog Node 1...")
        
        # 1. إنشاء Spark Session
        spark = SparkSession.builder \
            .appName("FogNode-1") \
            .config("spark.jars.packages", "org.apache.spark:spark-sql-kafka-0-10_2.12:3.3.0") \
            .config("spark.sql.streaming.checkpointLocation", "/tmp/checkpoint_node1") \
            .getOrCreate()
        ...
        print("📖 Lecture du topic sensor-data-node-1...")
        df = spark \
            .readStream \
            .format("kafka") \
        ...
        def process_batch(batch_df, batch_id):
            try:
                ...
                print(f"\n{'='*50}")
                print(f"🔧 Fog Node 1 - Batch {batch_id}")
        ...
        query = parsed_df \
            ...
            .option("checkpointLocation", "/tmp/checkpoint_fog_node_1") \
            .start()
        
        print("✅ Fog Node 1 fonctionne et attend les données...")
        ...
        print("\n⏹️ Fog Node 1 arrêté par l'utilisateur")
    except Exception as e:
        print(f"\n❌ Erreur principale : {e}")
        traceback.print_exc()
    finally:
